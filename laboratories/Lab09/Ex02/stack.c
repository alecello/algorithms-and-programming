...
/*
 *  print all the stack elements (FIFO policy)
 */
void fifo_print(FILE *fp, stack_t *sp, void (* print)(FILE *, void *))
{
  fifo_print_r(fp, sp->head, print);
}
